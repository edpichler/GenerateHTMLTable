...
/**
 * Test generating BLUE_TABLE (without divs)
 * */
public class TableGeneratorImplTest2 {
    ...
    public void testGenerateHtmlTable() throws Exception {
        ...
        String x = new TableGeneratorImpl().generateHtmlTable(matrix, TableStyle.BLUE_TABLE).toString();
        FileWriter fileWriter = new FileWriter(new File("tables1.html"));
        fileWriter.write(x);
        fileWriter.close();
    }
    ...
    public void testGenerateExampleHtmlTable() throws Exception {
        ...
        String x = new TableGeneratorImpl().generateHtmlTable(matrix, TableStyle.BLUE_TABLE).toString();
        FileWriter fileWriter = new FileWriter(new File("tables2.html"));
        fileWriter.write(x);
        fileWriter.close();
    }
}